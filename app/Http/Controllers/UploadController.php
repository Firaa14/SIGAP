...
class UploadController extends Controller
{
    ...
    private function getDummyPreviewData(): array
    {
        return [
            ...
            ['assetnum' => 'BLMJ030021', 'no_wo' => 'WO-2024-0889', 'description' => 'Bearing Temperature High',    'worktype' => 'CM',  'status' => 'INPRG', 'plta' => 'Lamajan',   'status_operasi' => 'Abnormal'],
            ...
            ['assetnum' => 'BWRJ010021', 'no_wo' => 'WO-2024-0911', 'description' => 'Runner Cavitation Repair',    'worktype' => 'EJ',  'status' => 'INPRG', 'plta' => 'Wonorejo',  'status_operasi' => 'Abnormal'],
            ['assetnum' => 'BPLG010009', 'no_wo' => 'WO-2024-0883', 'description' => 'Nozzle Cleaning & Check',     'worktype' => 'PAM', 'status' => 'CLOSE', 'plta' => 'Plengan',   'status_operasi' => 'Normal'],
        ];
    }
    ...
    public function preview(): View
    {
        ...
        $validationResults = [
            ...
            'found_plta' => ['Sengguruh', 'Sutami', 'Wlingi', 'Lamajan', 'Wonorejo', 'Plengan'],
        ];

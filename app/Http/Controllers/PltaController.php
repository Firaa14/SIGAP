...
class PltaController extends Controller
{
    ...
    private function getEquipmentData(): array
    {
        return [
            ...
            'tulungagung' => [
                ['unit' => 'UNIT 1', 'system' => 'TURBINE', 'equipment' => 'Pelton Wheel', 'kks' => 'BTLG-TG1-MAT10', 'assetnum' => 'BTLG010019', 'status_operasi' => 'Normal', 'keterangan' => ['no_wo' => 'WO-2024-0867', 'description' => 'Pelton Bucket Inspection', 'status' => 'CLOSE']],
                ['unit' => 'UNIT 1', 'system' => 'MECHANICAL', 'equipment' => 'Deflector', 'kks' => 'BTLG-TG1-MAD10', 'assetnum' => 'BTLG010031', 'status_operasi' => 'Abnormal', 'keterangan' => ['no_wo' => 'WO-2024-0894', 'description' => 'Deflector Actuator Fault', 'status' => 'APPR']],
            ],
            'wonorejo' => [
                ['unit' => 'UNIT 1', 'system' => 'TURBINE', 'equipment' => 'Kaplan Runner', 'kks' => 'BWNJ-TG1-MAT10', 'assetnum' => 'BWNJ010021', 'status_operasi' => 'Abnormal', 'keterangan' => ['no_wo' => 'WO-2024-0911', 'description' => 'Runner Cavitation', 'status' => 'INPRG']],
                ['unit' => 'UNIT 1', 'system' => 'MECHANICAL', 'equipment' => 'Oil Pressure Unit', 'kks' => 'BWNJ-TG1-MAO10', 'assetnum' => 'BWNJ010039', 'status_operasi' => 'Normal', 'keterangan' => ['no_wo' => 'WO-2024-0883', 'description' => 'Oil Pressure Check', 'status' => 'CLOSE']],
            ],
            'ampelgading' => [
                ['unit' => 'UNIT 1', 'system' => 'TURBINE', 'equipment' => 'Nozzle Assembly', 'kks' => 'BAMG-TG1-MAN10', 'assetnum' => 'BAMG010009', 'status_operasi' => 'Normal', 'keterangan' => ['no_wo' => 'WO-2024-0888', 'description' => 'Nozzle Cleaning', 'status' => 'CLOSE']],
                ['unit' => 'UNIT 2', 'system' => 'ELECTRICAL', 'equipment' => 'Bus Bar Protection', 'kks' => 'BAMG-TG2-EBP10', 'assetnum' => 'BAMG020026', 'status_operasi' => 'Normal', 'keterangan' => ['no_wo' => 'WO-2024-0872', 'description' => 'Bus Bar Inspection', 'status' => 'COMP']],
            ],
            'selorejo' => [
                ['unit' => 'UNIT 1', 'system' => 'TURBINE', 'equipment' => 'Turbine Bearing', 'kks' => 'BSLJ-TG1-MAB10', 'assetnum' => 'BSLJ010021', 'status_operasi' => 'Abnormal', 'keterangan' => ['no_wo' => 'WO-2024-0889', 'description' => 'Bearing Temperature High', 'status' => 'INPRG']],
                ['unit' => 'UNIT 2', 'system' => 'GENERATOR', 'equipment' => 'Generator Cooling', 'kks' => 'BSLJ-TG2-EGC10', 'assetnum' => 'BSLJ020047', 'status_operasi' => 'Normal', 'keterangan' => ['no_wo' => 'WO-2024-0865', 'description' => 'Cooling System PM', 'status' => 'CLOSE']],
            ],
            'golang' => [
                ['unit' => 'UNIT 1', 'system' => 'TURBINE', 'equipment' => 'Stay Vane', 'kks' => 'BGLG-TG1-MAV30', 'assetnum' => 'BGLG010013', 'status_operasi' => 'Normal', 'keterangan' => ['no_wo' => 'WO-2024-0848', 'description' => 'Stay Vane Inspection', 'status' => 'COMP']],
                ['unit' => 'UNIT 1', 'system' => 'MECHANICAL', 'equipment' => 'Wicket Gate', 'kks' => 'BGLG-TG1-MAW10', 'assetnum' => 'BGLG010029', 'status_operasi' => 'Not Ready', 'keterangan' => ['no_wo' => '-', 'description' => 'Gate Overhaul terjadwal', 'status' => 'NOT READY']],
            ],
            'giringan' => [
                ['unit' => 'UNIT 1', 'system' => 'TURBINE', 'equipment' => 'Crossflow Runner', 'kks' => 'BGRG-TG1-MAT10', 'assetnum' => 'BGRG010007', 'status_operasi' => 'Normal', 'keterangan' => ['no_wo' => 'WO-2024-0836', 'description' => 'Runner Maintenance', 'status' => 'CLOSE']],
                ['unit' => 'UNIT 1', 'system' => 'ELECTRICAL', 'equipment' => 'Control Panel', 'kks' => 'BGRG-TG1-ECP10', 'assetnum' => 'BGRG010018', 'status_operasi' => 'Abnormal', 'keterangan' => ['no_wo' => 'WO-2024-0915', 'description' => 'Control Panel Fault', 'status' => 'APPR']],
            ],
            'ngebel' => [
                ['unit' => 'UNIT 1', 'system' => 'TURBINE', 'equipment' => 'Pelton Buckets', 'kks' => 'BNBL-TG1-MAT10', 'assetnum' => 'BNBL010005', 'status_operasi' => 'Normal', 'keterangan' => ['no_wo' => 'WO-2024-0858', 'description' => 'Bucket Erosion Check', 'status' => 'COMP']],
                ['unit' => 'UNIT 1', 'system' => 'MECHANICAL', 'equipment' => 'Main Stop Valve', 'kks' => 'BNBL-TG1-MAV10', 'assetnum' => 'BNBL010016', 'status_operasi' => 'Normal', 'keterangan' => ['no_wo' => 'WO-2024-0841', 'description' => 'Valve Testing', 'status' => 'CLOSE']],
            ],
            'giringan' => [
                ['unit' => 'UNIT 1', 'system' => 'TURBINE', 'equipment' => 'Crossflow Runner', 'kks' => 'BGRG-TG1-MAT10', 'assetnum' => 'BGRG010007', 'status_operasi' => 'Normal', 'keterangan' => ['no_wo' => 'WO-2024-0836', 'description' => 'Runner Maintenance', 'status' => 'CLOSE']],
                ['unit' => 'UNIT 1', 'system' => 'ELECTRICAL', 'equipment' => 'Control Panel', 'kks' => 'BGRG-TG1-ECP10', 'assetnum' => 'BGRG010018', 'status_operasi' => 'Abnormal', 'keterangan' => ['no_wo' => 'WO-2024-0915', 'description' => 'Control Panel Fault', 'status' => 'APPR']],
